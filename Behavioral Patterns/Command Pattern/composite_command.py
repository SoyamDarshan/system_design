...
class MoneyTransferCommand(CompositeBankAccountCommand):
    def __init__(self, from_acct, to_acct, amount):
        super().__init__([BankAccountCommand(from_acct, BankAccountCommand.Action.WITHDRAW, amount),
...
if __name__ == "__main__":
    ...
    # )
    # illegal_cmd.invoke()
    # print(f'After impossible withdrawl: {ba}')
    # illegal_cmd.undo()
    # print(f'After undo withdrawl: {ba}')
    unittest.main()
